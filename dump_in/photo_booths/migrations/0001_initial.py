    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hashtag', models.ManyToManyField(related_name='photo_booth_brands', to='photo_booths.hashtag')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo_booth_brand', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='photo_booths.photoboothbrand')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
            options={
