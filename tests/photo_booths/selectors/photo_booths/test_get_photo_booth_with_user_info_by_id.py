...
class TestGetPhotoBoothWithdUserInfoById:
    ...
    def test_get_photo_booth_with_user_info_by_id_success_anonymous_user(self, photo_booth, inactive_user):
        photo_booth_data = self.photo_booth_selector.get_photo_booth_with_user_info_by_id(photo_booth.id, inactive_user)
