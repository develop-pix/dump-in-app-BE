...
class TestGetNearbyPhotoBoothQuerysetByName:
    ...
    def test_get_nearby_photo_booth_queryset_by_name_success_photo_booth(self, photo_booth):
        nearby_photo_booth_queryset = self.photo_booth_selector.get_nearby_photo_booth_queryset_by_name(
    ...
    def test_get_nearby_photo_booth_queryset_by_name_success_distance_500m(self, photo_booth):
        nearby_photo_booth_queryset = self.photo_booth_selector.get_nearby_photo_booth_queryset_by_name(
    ...
    def test_get_nearby_photo_booth_queryset_by_name_success_distance_1km(self, photo_booth):
        nearby_photo_booth_queryset = self.photo_booth_selector.get_nearby_photo_booth_queryset_by_name(
    ...
    def test_get_nearby_photo_booth_queryset_by_name_success_distance_1_5km(self, photo_booth):
        nearby_photo_booth_queryset = self.photo_booth_selector.get_nearby_photo_booth_queryset_by_name(
    ...
    def test_get_nearby_photo_booth_queryset_by_name_fail_out_of_range(self, photo_booth):
        nearby_photo_booth_queryset = self.photo_booth_selector.get_nearby_photo_booth_queryset_by_name(
    ...
    def test_get_nearby_photo_booth_queryset_by_name_fail_name_does_not_exist(self, photo_booth):
        nearby_photo_booth_queryset = self.photo_booth_selector.get_nearby_photo_booth_queryset_by_name(
            center_point=self.seoul_station_nearby_point,
            radius=1.5,
            name="fake_brand_name",
        )
