...
class TestGetPhotoBoothBrandQueryset:
    ...
    def test_get_photo_booth_brand_queryset_success_photo_booth_brands(self, photo_booth_brand_list):
        photo_booth_brands = self.photo_booth_brand_selector.get_photo_booth_brand_queryset()

        assert photo_booth_brands.count() == len(photo_booth_brand_list)
