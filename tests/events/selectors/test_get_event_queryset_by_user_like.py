...
class TestGetEventQuerysetByUserLike:
    ...
    def test_get_event_queryset_by_user_like_success(self, valid_event_list, valid_user):
        for valid_event in valid_event_list:
            valid_event.user_event_like_logs.add(valid_user)

        event_queryset_by_user_like = self.event_selector.get_event_queryset_by_user_like(valid_user)
    ...
    def test_get_event_queryset_by_user_like_fail_does_not_exist(self, valid_user):
        ...
        assert list(event_queryset_by_user_like) == []
