...
class TestGetReviewWithUserInfoById:
    ...
    def test_get_review_with_user_info_by_id_and_user_id_success(self, valid_review, valid_user):
        review_with_user_info = self.review_selector.get_review_with_user_info_by_id_and_user_id(valid_review.id, valid_user.id)
    ...
    def test_get_review_with_user_info_by_id_and_user_id_success_is_mine_true(self, valid_review):
        review_with_user_info = self.review_selector.get_review_with_user_info_by_id_and_user_id(valid_review.id, valid_review.user.id)
    ...
    def test_get_review_with_user_info_by_id_and_user_id_success_user_id_none(self, valid_review):
        review_with_user_info = self.review_selector.get_review_with_user_info_by_id_and_user_id(valid_review.id, None)

        assert review_with_user_info == valid_review

    def test_get_review_with_user_info_by_id_and_user_id_fail_does_not_exist(self, valid_user):
        review_with_user_info = self.review_selector.get_review_with_user_info_by_id_and_user_id(999, valid_user.id)
    ...
    def test_get_review_with_user_info_by_id_and_user_id_fail_deleted_review(self, deleted_review, valid_user):
        review_with_user_info = self.review_selector.get_review_with_user_info_by_id_and_user_id(deleted_review.id, valid_user.id)
