...
class TestGetReviewList:
    ...
    def test_get_review_list_success_single_review(self, valid_review):
        review_list = self.review_selector.get_review_list({})

        assert review_list.first() == valid_review

    def test_get_review_list_success_multiple_review(self, valid_review_list):
        review_list = self.review_selector.get_review_list({})
    ...
    def test_get_review_list_success_with_concept(self, valid_review_list_concept):
        ...
        review_list = self.review_selector.get_review_list({"concept": concept_name})
