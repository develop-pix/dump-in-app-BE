...
class TestUserService:
    ...
    def test_update_user_success(self, group, user_social_provider, new_users):
    ...
    def test_update_user_fail_nickname_is_too_long(self, group, user_social_provider, new_users):
    ...
    def test_update_user_fail_exist_nickname(self, group, user_social_provider, new_users):
        with pytest.raises(ValidationException) as e:
            self.service.update_user(
                user_id=12,
                nickname="test11",
