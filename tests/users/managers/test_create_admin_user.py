...
class TestCreateAdminUser:
    ...
    def test_create_admin_fail_duplicate_nickname(self, user_social_provider, group, valid_user):
        email = "test1234@test.com"
    ...
    def test_create_admin_fail_duplicate_username(self, user_social_provider, group, valid_user):
        email = "test1234@test.com"
        nickname = "test1234"
